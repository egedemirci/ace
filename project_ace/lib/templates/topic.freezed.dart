...
abstract class $TopicCopyWith<$Res> {
  ...
  $Res call({String text, List<dynamic> postIdList});
}
...
class _$_Topic implements _Topic {
  const _$_Topic(
      {required this.text, final List<dynamic> postIdList = const <dynamic>[]})
  ...
  @override
  String toString() {
    return 'Topic(text: $text, postIdList: $postIdList)';
  }
...
abstract class _Topic implements Topic {
  const factory _Topic(
      {required final String text, final List<dynamic> postIdList}) = _$_Topic;
