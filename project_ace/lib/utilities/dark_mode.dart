...
class AppColors {
  ...
  // Messages
  // Posts
  static const Color postTextColor = Color(0xFFB9D3DF);
  static const Color userFullNameColor = Color(0xFFB9D3DF);
  static const Color userNameColor = Color(0xFFB9D3DF);
  // Create Post
  static const Color mainAppPostTextColor = Color(0xFFD9D9D9);
  static const Color mainAppSmallUsernameColor = Color(0xFFFBBC05);
