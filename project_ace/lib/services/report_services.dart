...
class ReportService{
  ...
  Future<void> reportUser(String reportedUserId, String reporterUserId, String reportedUsername) async{
    userReports.add(
        {
    ...
    sendEmailUser(reporterUserId: reporterUserId, reportedUserId: reportedUserId, reportedUsername: reportedUsername, );
  }
  Future<void> reportPost(String reporterUserId, String reportedPostId, String reportedUserId, String reportedUsername) async{
    ...
    sendEmailPost(reporterUserId: reporterUserId, reportedUserId: reportedUserId, reportedUsername: reportedUsername, reportedPostId: reportedPostId);
  }
}